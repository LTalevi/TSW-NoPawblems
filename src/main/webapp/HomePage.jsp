...
<body>
	...
	<header>
		...
		<button class="arrow_button_header prev" aria-label="prodotto precedente">
	    	<i class="material-icons">keyboard_arrow_left</i>
	  	</button>
	  			
		<img src=<%=urlImmagineHeader //recuperare slideshow immagini da database %>>
	
		<button class="arrow_button_header next" aria-label="prodotto successivo">
