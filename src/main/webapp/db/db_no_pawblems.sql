...
INSERT INTO UTENTE (NOME, COGNOME, EMAIL, TELEFONO, PASSWORD, ADMIN) VALUES ('VuoLevi', 'User', 'vuolevi@usertest.com', '3331234567', TO_BASE64(UNHEX(SHA2('UserTest00..', 256))), FALSE);

-- Indirizzi Utente Test
INSERT INTO INDIRIZZO (UTENTE, VIA, CITTA, CAP, PROVINCIA, NAZIONE) VALUES (1, 'Via Roma 10', 'Milano', '20100', 'MI', 'Italia');
INSERT INTO INDIRIZZO (UTENTE, VIA, CITTA, CAP, PROVINCIA, NAZIONE) VALUES (1, 'Via Napoli 25', 'Roma', '00100', 'RM', 'Italia');
INSERT INTO INDIRIZZO (UTENTE, VIA, CITTA, CAP, PROVINCIA, NAZIONE) VALUES (1, 'Piazza San Marco 1', 'Venezia', '30124', 'VE', 'Italia');

-- Ordini Utente Test
INSERT INTO ORDINE (UTENTE, VIA_SPEDIZIONE, CITTA_SPEDIZIONE, CAP_SPEDIZIONE, PROVINCIA_SPEDIZIONE, NAZIONE_SPEDIZIONE, DATA_ORDINE, STATO, TOTALE, NUMERO_FATTURA) VALUES (1, 'Via Roma 10', 'Milano', '20100', 'MI', 'Italia', '2023-10-01 10:30:00', 'Consegnato', 55.99, 'FATT-2023-001');
INSERT INTO ORDINE (UTENTE, VIA_SPEDIZIONE, CITTA_SPEDIZIONE, CAP_SPEDIZIONE, PROVINCIA_SPEDIZIONE, NAZIONE_SPEDIZIONE, DATA_ORDINE, STATO, TOTALE, NUMERO_FATTURA) VALUES (1, 'Via Napoli 25', 'Roma', '00100', 'RM', 'Italia', '2023-11-15 15:45:00', 'Spedito', 92.89, 'FATT-2023-089');
INSERT INTO ORDINE (UTENTE, VIA_SPEDIZIONE, CITTA_SPEDIZIONE, CAP_SPEDIZIONE, PROVINCIA_SPEDIZIONE, NAZIONE_SPEDIZIONE, DATA_ORDINE, STATO, TOTALE, NUMERO_FATTURA) VALUES (1, 'Via Roma 10', 'Milano', '20100', 'MI', 'Italia', '2023-12-05 09:15:00', 'In Elaborazione', 28.90, 'FATT-2023-150');

-- Dettaglio Ordine Utente Test
INSERT INTO DETTAGLIO_ORDINE (ORDINE, VARIANTE, QUANTITA, PREZZO_ACQUISTO, IVA_ACQUISTO) VALUES (1, 1, 1, 55.99, 22);
INSERT INTO DETTAGLIO_ORDINE (ORDINE, VARIANTE, QUANTITA, PREZZO_ACQUISTO, IVA_ACQUISTO) VALUES (2, 5, 1, 12.99, 22);
INSERT INTO DETTAGLIO_ORDINE (ORDINE, VARIANTE, QUANTITA, PREZZO_ACQUISTO, IVA_ACQUISTO) VALUES (2, 6, 1, 79.90, 22);
INSERT INTO DETTAGLIO_ORDINE (ORDINE, VARIANTE, QUANTITA, PREZZO_ACQUISTO, IVA_ACQUISTO) VALUES (3, 18, 1, 28.90, 22);

-- Utente Amministratore (Admin)
INSERT INTO UTENTE (NOME, COGNOME, EMAIL, TELEFONO, PASSWORD, ADMIN) VALUES ('VuoLevi', 'Admin', 'vuolevi@admintest.com', '3339876543', TO_BASE64(UNHEX(SHA2('AdminTest00..', 256))), TRUE);
